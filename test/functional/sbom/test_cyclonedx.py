...
def post_package(conanfile):
    sbom_cyclonedx_1_4 = cyclonedx_1_4(conanfile, conanfile.subgraph, add_build=%s, add_tests=%s)
...
def post_generate(conanfile):
    sbom_cyclonedx_1_4 = cyclonedx_1_4(conanfile, conanfile.subgraph, name=%s)
